...
for problem_size in [20, 50, 100]:
    ...
    for _ in range(SIGNIFICANCE_RUNS):
        ...
        avg_over_val_data = validate_best_variable(heuristic_network, min_problem_size, max_problem_size, n_ants, avg=False)
...
if False:
    ...
    for _ in range(SIGNIFICANCE_RUNS):
        heuristic_network = neuralnetwork.GNN(32, 12)
        avg_over_val_data = validate_best_variable(None, min_problem_size, max_problem_size, n_ants, avg=False)
        data_for_model.append(avg_over_val_data)
